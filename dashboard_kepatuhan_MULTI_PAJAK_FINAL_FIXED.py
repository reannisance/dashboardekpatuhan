...
if uploaded_file:
    ...
    # Normalisasi nama kolom (untuk validasi)
    ...
    if missing_cols:
        ...
        # Rename ke Title Case untuk tampil bagus
        df_input.rename(columns={col: col_mapping[col].title().strip() for col in df_input.columns}, inplace=True)
