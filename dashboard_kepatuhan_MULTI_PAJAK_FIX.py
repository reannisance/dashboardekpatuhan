...
if uploaded_file:
    ...
    df_input.columns = [col.upper().strip() for col in df_input.columns]
    ...
    if missing_cols:
        ...
        df_input.rename(columns={col: col.title() for col in df_input.columns}, inplace=True)
